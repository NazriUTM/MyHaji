...
class AddReportPage extends StatefulWidget {
  ...
  AddReportPage({Key key, this.data}) : super(key: key);
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () async {
          ...
          User updatedUser = await dataService.createReport(newReport, user);
          Navigator.pop(context);
          Navigator.push(
              context,
              new MaterialPageRoute(
                  builder: (BuildContext context) =>
                      new ReportPage(updatedUser)));
        },
